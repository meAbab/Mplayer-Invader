...
function create() {
	...
	//enemyBullets2.createMultiple(30, 'enemyBullet');
...
function collisionHandler (bullet, alien) {
   ...
   life = life-1;
	...
	// when first player life is equal 5, then another new player will appear
	/*if(life == 5) 	{
	aliens2 = game.add.sprite(48,50, 'invader');
	aliens2.anchor.setTo(0.5,0.5);
	game.physics.enable(aliens2, Phaser.Physics.ARCADE);
    createAliens2();
	}*/
    if(life < 1)    {	
		alien.kill();
...
function enemyFires () {
	...
	if(enemyBullet > 0) {
		enemyBullet.reset(aliens.body.x, aliens.body.y);
...
/*function enemyFires2 () {
	...
	if (enemyBullet2){
        ...
        enemyBullet2.reset(aliens2.x, aliens2.y);
